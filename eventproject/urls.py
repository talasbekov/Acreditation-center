...
urlpatterns = [
    ...
    path('delete_attendee_admin/', views.delete_attendee_admin, name="delete_attendee_admin"),
    ...
    path('show_request_to_admin/<int:request_id>/', views.show_request_to_admin, name='show_request_to_admin'),
	path('avmac/', views.index, name='index'),
    path('flush_outdated_events/', views.flush_outdated_events, name='flush_outdated_events'),
