...
urlpatterns = [
    ...
    path(
        "delete_request/<int:request_id>/", delete_request, name="delete_request"
    ),
    path("preview/<int:request_id>/", preview, name="preview"),
    path(
        "back_to_change/<int:request_id>/", back_to_change, name="back_to_change"
    ),
    ...
    path(
        "delete_operator/<str:username>/", delete_operator, name="delete_operator"
    ),
    path(
    ...
    path(
        "download_photos/<int:event_id>/", download_photos, name="download_photos"
    ),
