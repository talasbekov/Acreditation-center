...
urlpatterns = [
    ...
    path("update/<int:attendee_id>/", views.update_attendee, name="update_attendee"),
    path("delete_attendee/", views.delete_attendee, name="delete_attendee"),
    path("delete_attendee_from_admin/", views.delete_attendee_from_admin, name="delete_attendee_from_admin"),
