    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created_operator', to='eventproject.operator')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eventproject.event')),
                ('exported_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exported_operator', to='eventproject.operator')),
            ],
        ),
        migrations.CreateModel(
            name='Attendee',
            fields=[
                ...
                ('docScan', models.ImageField(blank=True, upload_to='attendee_document')),
                ...
                ('request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eventproject.request')),
            ],
        ),
    ]
