...
class QrIin(models.Model):
    ...
    # Хранится зашифрованным (Fernet), как Attendee.iin — фильтрация по iin невозможна
    iin = EncryptedCharField(max_length=12, validators=[iin_validator, iin_kz_validator], null=False, blank=False)
