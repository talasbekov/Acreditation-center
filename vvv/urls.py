...
#     path('show_request_to_admin/<int:request_id>/', show_request_to_admin, name='show_request_to_admin'),
...
#     path('unbind_event/<int:event_id>/<str:username>/', unbind_event, name='unbind_event'),
...
#     path('download_guests_json/<int:event_id>/', download_guests_json, name='download_json'),
...
#     path('download_request_json/<int:request_id>/', download_request_json, name='download_request_json'),
#     path('download_all_guests_json/<int:event_id>/', download_all_guests_json, name='download_all_guests_json'),
...
#     path('kz/back_to_change/<int:request_id>/', kviews.back_to_change, name='back_to_change'),
#     path('en/back_to_change/<int:request_id>/', eviews.back_to_change, name='back_to_change'),
